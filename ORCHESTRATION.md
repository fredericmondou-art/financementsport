...
- `docs/prompts/phase-0-et-1.md` — les 11 tâches à exécuter, dans l'ordre, avec
  leurs critères d'acceptation et leurs tests.
- `docs/prompts/phase-1-4.md` — Phase 1.4 : design UI/UX professionnel + mise en
...
- `docs/prompts/phase-1-5.md` — Phase 1.5 : campagne pleinement opérationnelle.
  À faire EN DERNIER de ce groupe.
- `docs/gabarit-rapport.md` — le gabarit du rapport que tu produis après chaque
  tâche.
...
2. Prends la PROCHAINE tâche non terminée, dans l'ordre, en suivant la séquence
   des phases :
   a. `docs/prompts/phase-0-et-1.md` (tâches 0.1 → 1.7) — fondations + flux
      vendable
   b. `docs/prompts/phase-1-4.md` (1.4.1 → 1.4.6) — design + mise en ligne
   c. `docs/prompts/phase-1-6.md` (blocs A, puis B, puis C) — UX des usagers
   d. `docs/prompts/phase-1-5.md` (1.5.1 → 1.5.11) — campagne opérationnelle
...
6. **Produis le rapport de la tâche** en suivant le gabarit de
   `docs/gabarit-rapport.md` : écris-le dans `docs/rapports/RAPPORT-<numéro>.md`
   ET présente-le-moi dans la conversation. Ce rapport est OBLIGATOIRE après
   chaque tâche, sans exception.
