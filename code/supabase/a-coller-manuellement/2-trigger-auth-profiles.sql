...
-- A executer APRES le fichier 1-schema-et-seed.sql.
-- Cree le trigger qui genere automatiquement un `profiles` a chaque
-- inscription (auth.users). Sans danger a re-executer (CREATE OR REPLACE +
